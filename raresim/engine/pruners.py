...
class FunctionalSplitPruner(Pruner):
    ...
    def transform(self):
        ...
        if mode == 'func_split':
            ...
            prune_bins(extra_rows, bin_assignments, self.__legend, self.__matrix, self.__bins['fun'], self.__config.activation_threshold, self.__config.stop_threshold)
        elif mode == 'syn_only':
            prune_bins(extra_rows, bin_assignments, self.__legend, self.__matrix, self.__bins['syn'], self.__config.activation_threshold, self.__config.stop_threshold)
